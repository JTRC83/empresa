...
El orden lógico de los documentos sigue este flujo:

```
Diagnóstico → Proceso Creativo → Estrategia → Naming → Arquitectura Operativa
```

1. **Diagnóstico y Evaluación** — retrato del negocio, bloqueos y dirección
...
- [[01 - Diagnóstico y Evaluación/Sesion_valoracion_0005|Sesión de Valoración - Retrato del Negocio]] — Documento fundacional del proceso

### [[02 - Proceso Creativo]]
- [[02 - Proceso Creativo/INFORME_ESTRATEGIA_CREATIVA_0002 (1)|Informe Estrategia Creativa - Proceso 7 Días (Versión Completa)]] — Narrativa día por día
- [[02 - Proceso Creativo/INFORME_ESTRATEGIA_CREATIVA_0002|Informe Estrategia Creativa - Síntesis]] — Versión resumida
...
> [!tip] Notas atómicas extraídas de los documentos
> Cada concepto es una nota independiente con sus relaciones.

### Estrategia y Concepto
- [[Concepto Central - De aislado a conectado]]
- [[Concepto Central Actualizado - De componentes aislados a sistemas operativos inteligentes]]
- [[ADN - Tecnología-Tierra]]
- [[Manifesto - La red es el todo]]

### Identidad y Storytelling
- [[Insight de Origen - Tecnología como refugio]]
- [[Hito Narrativo - La noche de la pizarra 5 junio 2025]]
...
- [[Diferenciación - Inventor vs Técnico]]
...
- [[06 - Proyectos/CanvasAPI|CanvasAPI]] — editor de canvas visual con API
- [[06 - Proyectos/Atenfy|Atenfy]] — manager de bots y llamadas con IA multicanal
- [[06 - Proyectos/Foundation|Foundation]] — plantilla modular SaaS (monorepo Turborepo)
- [[06 - Proyectos/GenLegalTxts|GenLegalTxts]] — generador de textos legales para webs
- [[06 - Proyectos/Valor Balear|Valor Balear]] — marketplace de productos locales baleares

## Mapa de relaciones

> [!warning] Visualizar conexiones
> Abre [[Mapa Relaciones.canvas|Mapa Relaciones]] para ver el diagrama interactivo de documentos y conceptos.
