...
- [[Atenfy|Atenfy]] — - **Manager de bots y llamadas con IA multicanal** `#proyecto #producto #bots #ia #llamadas #multicanal #reservas #atención-cliente #chatbot #whatsapp #instagram #agenda #ventas #som-u #ecosistema`
- [[CanvasAPI|CanvasAPI]] — - **API-First Template Engine** — Motor de plantillas visuales orientado a API `#proyecto #producto #api #canvas #json #ia #editor #template-engine #generación-visual #pdf #som-u #ecosistema`
